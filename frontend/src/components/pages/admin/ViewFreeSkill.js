...
export default function ViewFreeSkill() {
    ...
    <>
      ...
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb bg-secondary-subtle py-4 fs-4 d-flex justify-content-center">
          ...
          <li className="breadcrumb-item">
            <Link className="text-decoration-none text-secondary" to={"/admin/viewfreeskill/"+id+"/"+userid}>View FreeSkills</Link>
          </li>
        </ol>
      </nav>
      {/* Breadcrumb end */}
